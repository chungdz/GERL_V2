...
mkdir data
cd data
mkdir L L/train L/dev L/test vocabs
cd ..
...
python -m src.scripts.build_train_examples
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python src.train
CUDA_VISIBLE_DEVICES=0,1,2,3 python src.test training.validate_epoch=6  